...
(function () {
  ...
  function ensureStyle() {
    ...
    var css = ''
      ...
      + '.shop-ico{width:64px;height:64px;display:flex;align-items:center;justify-content:center;overflow:visible;border-radius:0;background:transparent;font-size:28px;flex-shrink:0;}'
      + '.shop-ico img{position:relative;z-index:1;width:100%;height:100%;object-fit:contain;background:transparent;border-radius:0;}'
